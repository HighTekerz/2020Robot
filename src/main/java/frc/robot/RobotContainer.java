...
public class RobotContainer {
    ...
    private CameraSystem camSys = CameraSystem.getInstance();
    ...
    private void configureButtonBindings() {
        ...
        new JoystickButton(meatStick, joyButts.START)
                .whenPressed(new InstantCommand(() -> shooter.setSetpoint(shooter.POSITION1SPEED)));
